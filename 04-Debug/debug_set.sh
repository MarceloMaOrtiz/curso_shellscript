...
# Com o set é possível selecionar partes específicar do código
# para executar o debug do bash, podendo utilizar os mesmos
# parâmetros -x -v. Para fechar a parte específica utilizamos
# set +x +v. Possibilitando pegar somente linhas específicas.
set -x
while test -n "$1"; do
    case "$1" in
